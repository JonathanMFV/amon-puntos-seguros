export default function Footer() {
    return (
        <div className="flex flex-row justify-start my-32 mx-32">
            <div className="flex-col w-full">
                <div className="flex flex-row gap-36">
                    <div>
                        <p className="font-bold text-xl">AmonPuntosSeguros</p>
                    </div>
                    ...
                    <div className="flex flex-col gap-y-4">
                        ...
                        <p className="text-sm font-light">amoncultural@tec.ac.cr</p>
                    </div>
                </div>
                <div className="flex w-[100%] h-10 border-t mt-32 items-center justify-center">
                    <p>Copyright © Amon Cultural</p>
                </div>
            </div>
        </div>
    );
